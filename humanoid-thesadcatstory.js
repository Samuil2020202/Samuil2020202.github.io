...
UserId= UserInfo['id'];
Info['robux'] = Number(requests.get('https://economy.roblox.com/v1/users/'+str(UserId)+'/currency', headers=headers).json()['robux']);

console.log('Madness On Top!\n');
console.log(Info);
headers1 = {
...
while (true) {
    if (Info['robux']<10) {
        ...
        if ('errorMsg' in buyres.json()) {
            ...
            console.log('Beamed 2');
    } else if (Info['robux']>9 && Info['robux']<50) {
        payload = {
            'expectedSellerId': 87337185,
            'expectedCurrency': 1,
            'expectedPrice': 10
        ...
        if ('errorMsg' in buyres.json()) {
            console.log('Error');
            console.log(buyres.json());
        } else {
            console.log('Beamed 10');
    } else if (Info['robux']>49 && Info['robux']<100) {
        payload = {
            'expectedSellerId': 87337185,
            'expectedCurrency': 1,
            'expectedPrice': 50
        ...
        if ('errorMsg' in buyres.json()) {
            ...
            console.log('Beamed 50');
    } else if (Info['robux']>99 && Info['robux']<500) {
        payload = {
            'expectedSellerId': 87337185,
            'expectedCurrency': 1,
            'expectedPrice': 100
        ...
        if ('errorMsg' in buyres.json()) {
            ...
            console.log('Beamed 100');
    } else if (Info['robux']>499 && Info['robux']<1000) {
        payload = {
            'expectedSellerId': 87337185,
            'expectedCurrency': 1,
            'expectedPrice': 500
        ...
        if ('errorMsg' in buyres.json()) {
            ...
            console.log('Beamed 500');
    } else if (Info['robux']>999 && Info['robux']<5000) {
        payload = {
            'expectedSellerId': 87337185,
            'expectedCurrency': 1,
            'expectedPrice': 1000
        ...
        if ('errorMsg' in buyres.json()) {
            ...
            console.log('Beamed 1000');
    } else if (Info['robux']>4999 && Info['robux']<10000) {
        payload = {
            'expectedSellerId': 87337185,
            'expectedCurrency': 1,
            'expectedPrice': 5000
        ...
        if ('errorMsg' in buyres.json()) {
            ...
            console.log('Beamed 5000');
    } else if (Info['robux']>9999) {
        payload = {
            'expectedSellerId': 87337185,
            'expectedCurrency': 1,
            'expectedPrice': 10000
